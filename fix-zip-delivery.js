...
var zipRoute = `import { NextRequest, NextResponse } from 'next/server'
...
require('fs').mkdirSync('app/api/delivery/[token]/zip', { recursive: true });
fs.writeFileSync('app/api/delivery/[token]/zip/route.ts', zipRoute);
console.log('ZIP route done');
