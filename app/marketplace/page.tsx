...
const Z2B_FEATURED = [
  ...
  },
  {
    ...
    badge:       'Z2B APP',
    title:       'Amavulandlela',
    subtitle:    'Market Everything You Build',
    desc:        'AI-powered social media captions for your own business, NWM company or influencer brand. Facebook, Instagram and TikTok — 90% automated. Bronze members included free.',
    price:       199,
    cta:         'Get Amavulandlela →',
