    ...
    <div className="min-h-screen" style={{ background: '#080608' }}>
      <div className="px-4 py-2 flex items-center justify-between flex-wrap gap-2"
        ...
        <span style={{ color: '#f0c040', fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '2px', fontSize: '0.65rem' }}>
          🎧 AUDIO READER — ZERO2BILLIONAIRES
        </span>
        <div className="flex gap-3">
          ...
          <Link href="/reader" className="text-xs px-3 py-1 rounded-sm" style={{ fontFamily:'Bebas Neue,sans-serif', letterSpacing:'2px', background:'rgba(201,162,39,0.15)', color:'#f0c040', border:'1px solid rgba(201,162,39,0.3)' }}>📚 READER</Link>
      ...
      <iframe src="/z2b_audio_reader.html" className="w-full" style={{ height:'calc(100vh - 44px)', border:'none' }} title="Zero2Billionaires Audio Reader"/>
    </div>
  )
}
