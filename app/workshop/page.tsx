...
[[MIRROR_MOMENT]]`,
  ...
  // ---- PAID TIER: SESSIONS 61–90 — FULLY WRITTEN ----
  {
    id: 61, free: false,
...
[[MIRROR_MOMENT]]`,
    ...
    questions: [
      { q: "The third path — the Entrepreneurial Consumer — is described at the end of Session 90 as:", options: ["A theoretical concept that may work for some people in certain markets", "Real and proven — not just intellectually known but experienced through 99 sessions of application, reflection and growth that have changed how the builder thinks about themselves and their future", "An aspiration that requires ideal conditions to achieve", "A starting point that must be supplemented by returning to employment eventually"], answer: 1 },
      { q: "The Final Session is described as a commissioning rather than a summary because:", options: ["Summaries are not allowed in the Z2B curriculum", "You do not graduate from the EC journey — you advance within it; the commissioning is a sending forward, not a completion", "Session 90 content could not fit within a summary format", "Commissionings are required by the Z2B certification programme"], answer: 1 },
