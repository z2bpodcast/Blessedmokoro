    ...
    const gearOptions = [
      {
        ...
        desc: 'Your script becomes the foundation. 4M researches the market, writes the full product, evaluates quality and packages it. Best when your content is rough notes or early ideas.',
        badge: 'Recommended',
        badgeColor: '#10B981',
      },
      {
        ...
        desc: 'Your script is already well-written and structured. 4M reads it, scores it across 8 quality criteria, rewrites weak sections and packages it with bonus assets.',
        badge: 'Content Ready',
        badgeColor: '#D4AF37',
      },
      {
        ...
        desc: 'Your content is polished and ready. 4M adds interactive assets (checklist, workbook, templates), generates your cover page with your author name and prepares for launch.',
      ...
      },
      {
        ...
        desc: 'Your product is completely finished. 4M creates your marketplace listing, generates social media posts and publishes it to the Z2B Marketplace immediately.',
        badge: 'Launch Ready',
        badgeColor: '#06B6D4',
      },
    ]
