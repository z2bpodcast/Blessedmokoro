...
const NAV_SECTIONS = [
  ...
  { href:'/z2b-command-7x9k/open-table',         icon:'🍽️', label:'Open Table Manager',     desc:'Update Meet link · Session note · Activate/deactivate',             color:'#059669', bg:'#D1FAE5', roles:['ceo','superadmin'] },
    { href:'/z2b-command-7x9k/notifications',       icon:'🔔', label:'Notification Centre',     desc:'Push notifications · WhatsApp blast · Member list',                  color:'#4C1D95', bg:'#F3E8FF', roles:['ceo','superadmin'] },
    { href:'/z2b-command-7x9k/ai-income',         icon:'🤖', label:'AI Income Monitor',       desc:'Unlocks · Commissions · Referral tracking · Payouts',         color:'#059669', bg:'#D1FAE5', roles:['ceo','superadmin'] },
    { href:'/z2b-command-7x9k/workshop-unlock',    icon:'🔓', label:'Workshop Unlock',          desc:'Manually unlock any sessions for any member — individual or bulk range',     color:'#B45309', bg:'#FEF3C7', roles:['ceo','superadmin'] },
    { href:'/z2b-command-7x9k/workshop-progress',  icon:'📊', label:'Workshop Progress',         desc:'Monitor all members · Session tracking · WhatsApp milestone messages', color:'#0EA5E9', bg:'#E0F2FE', roles:['ceo','superadmin','admin'] },
